...
Para elegir un elemento aleatorio de una lista usar c.
...
#leemos el archivo
with open("Laberintos\map1.txt", 'r') as laberirnto:
    laberinto1 = list(laberirnto)
#limpiamos el mapa
laberinto1 = str(laberinto1).replace(" ","").replace("[","").replace("'","").replace("]","")
#coordenadas
coordenadasInicio = (laberinto1[0],laberinto1[0])
dimension = (laberinto1[2:4], laberinto1[4:6])
